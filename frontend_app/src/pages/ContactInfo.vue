...
const dialCodes: Record<string, string> = {
    ru: '+7', kk: '+7', uz: '+998', ky: '+996', tg: '+992', az: '+994', hy: '+374', ro: '+40', ka: '+995',
}
...
<template>
    <div class="flex flex-col items-center min-h-screen bg-gradient-to-b from-sky-50 to-white px-4 py-8">
        <main class="flex flex-col items-center justify-center text-center space-y-6 max-w-2xl flex-1 w-full">
            ...
            <label for="phone-input" class="block text-left w-full max-w-xl mt-4 mb-1 font-medium text-gray-700">
                {{ t('contact_info.enter_email') }}
            </label>
            <!-- Email input -->
            <input v-model="email" type="email" :placeholder="'myemail@ingosstrah.ru'"
            ...
            <div class="w-full max-w-xl flex gap-3 items-center">
                ...
                <div class="relative">
                    ...
                    <img :src="`/flags/${selectedCountry}.svg`"
