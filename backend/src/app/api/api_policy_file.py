...
# def generate_xlsx(req: GenerateReq):
#     c = compute_policy(
#         employee_tab_number=req.policy.employee_tab_number,
#         arrived_for_hire=req.policy.arrived_for_hire,
#         last_name=req.user.last_name,
#         first_name=req.user.first_name,
#         middle_name=req.user.middle_name,
#         birthday=req.user.birthday,
#         passport_series=req.user.passport_series,
#         passport_number=req.user.passport_number,
#         start_date=req.policy.start_date,
#         end_date=req.policy.end_date,
#         base_premium=req.policy.base_premium,
#         seq=req.policy.seq,
#     )
...
#     out_path = render_policy_xlsx(values, out_name=c.policy_number)
